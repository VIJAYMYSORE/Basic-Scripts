    ...
    */
    class DbUtil
    {
        ...
        */
        ...
        {
            //Not a singleton!!!
            return new DbUtil($db_host, $db_user, $db_passwd, $db_database, $db_timeout, $db_persistant,$db_port);
        }
        ...
        */
        static public function GetDBConnection($dbName=DB_MAIN_RW, $transactions=false, $namespace='', $exceptions=false)
        {
            ...
            if (isset(self::$m_Connections[$key]) && is_object(self::$m_Connections[$key])) {
                ...
                $dbConnection = new DbUtil($db_host, $db_user, $db_passwd, $db_database, $db_timeout, $db_persistant,$db_port);
        ...
        */
        public function EscapeString($inString,$useNonDb=false)
        {
            ...
            if($this->m_throwException) {
                precondition(is_numeric($inString) || is_string($inString),'$inString not a string or number',-1,INTERNAL_SERVER_ERROR,Logger_MetricsEvents::EVENT_ERROR_DBUTIL);
            }
        ...
        * $dbConn = DbUtil::GetDbConnection(DB_MAIN_RW);
